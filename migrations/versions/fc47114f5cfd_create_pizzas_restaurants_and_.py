"""Create pizzas, restaurants and restaurant_pizzas tables

Revision ID: fc47114f5cfd
Revises: 
Create Date: 2023-09-23 20:42:51.174399
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id', 'pizza_id', 'restaurant_id')
    )
